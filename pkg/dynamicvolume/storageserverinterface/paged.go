...
type StorageServerInterfacePage struct {
	Page        int                      `json:"page"`
...
func (f StorageServerInterfacePage) Options() []param.Parameter {
	return f.pageOptions
}

func (f StorageServerInterfacePage) Num() int {
	return f.Page
}

func (f StorageServerInterfacePage) Size() int {
	return f.Limit
}

func (f StorageServerInterfacePage) Total() int {
	return f.TotalPages
}

func (f StorageServerInterfacePage) Content() interface{} {
	return f.Data
}
...
func (a *api) GetPage(ctx context.Context, page, limit int, parameters ...param.Parameter) (pagination.Page, error) {
	...
	payload := struct {
		Page StorageServerInterfacePage `json:"data"`
	}{}
