...
type Definition struct {
	...
	ServiceVM01InternalIPv4Address string     `json:"service_vm_01_internal_ipv4_address"`
	ServiceVM02InternalIPv4Address string     `json:"service_vm_02_internal_ipv4_address"`
	ServiceVM01ExternalIPv4Address string     `json:"service_vm_01_external_ipv4_address"`
	ServiceVM02ExternalIPv4Address string     `json:"service_vm_02_external_ipv4_address"`
	ServiceVM01ExternalIPv6Address string     `json:"service_vm_01_external_ipv6_address"`
	ServiceVM02ExternalIPv6Address string     `json:"service_vm_02_external_ipv6_address"`
}
