// The helper package exists to break a circular-dependency between pkg/api and pkg/apis/core/v1, that
// was introduced when adding the AutoTag option to the generic client.
// Be careful what you use from this package, it should not contain anything valueable for users outside
// go-anxcloud itself.
package helper
